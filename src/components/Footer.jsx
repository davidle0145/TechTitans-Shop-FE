            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  <p>TechTitans Shop</p>
                  <p>No. 150 Nguyen Van Linh, Nam Duong, Hai Chau, Da Nang 550000</p>
                </address>
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">&copy; {new Date().getFullYear()} - Power by TechTitans Shop</p>
            </div>
          </div>
        </div>
      </footer>
